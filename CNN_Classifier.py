...
# loading dataset
train = pd.read_csv('/content/drive/MyDrive/charts (1)/charts/train_val.csv')
...
for img_name in tqdm(train['image_index']):
    ...
    image_path = '/content/drive/MyDrive/charts (1)/charts/train_val/' + str(img_name) + '.png'
    # reading the image
...
for img_name in range(50):
    # defining the image path
    image_path = '/content/drive/MyDrive/charts (1)/charts/test/' + str(img_name) + '.png'
     # reading the image
    img = imread(image_path)
    # converting the type of pixel to float 32
    img = img.astype('float32')
